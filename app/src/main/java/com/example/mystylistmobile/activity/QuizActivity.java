...
public class QuizActivity extends AppCompatActivity {
    ...
    public void showBodyTypeQuiz(){
      //  this.showBodyTypeQuestion(currentUndertoneQuestionIndex);
    ...
    public void showUndertoneQuiz(){
       // this.showUndertoneQuestion(currentUndertoneQuestionIndex);
    ...
    public void showAnswer(int numberOfAnswer, int questionIndex, String [][] answers){
        if (numberOfAnswer == 2){
            ...
            btn_choose1.setText(answers[questionIndex][0]);
            btn_choose2.setText(answers[questionIndex][1]);
        }
            ...
            btn_choose1.setText(answers[questionIndex][0]);
            btn_choose2.setText(answers[questionIndex][1]);
            btn_choose3.setText(answers[questionIndex][2]);
        }
            ...
            btn_choose2.setText(answers[questionIndex][1]);
            btn_choose3.setText(answers[questionIndex][2]);
            btn_choose4.setText(answers[questionIndex][3]);
        }
    }

    public void showQuestion(int questionIndex, int totalNumberQuestion,String[] questions, String[][] answers){
        number_question.setText(totalNumberQuestion);
        text_question.setText(questions[questionIndex]);
        showAnswer(answers[questionIndex].length, questionIndex, answers);
    }
    public void showUndertoneQuestion(int questionIndex){
        int totalNumberQuestion = undertoneQuestions.length + contrastQuestions.length;
        number_question.setText((questionIndex+1) + "/" + totalNumberQuestion);
        text_question.setText(undertoneQuestions[questionIndex]);
        showAnswer(undertoneAnswers[questionIndex].length, questionIndex, undertoneAnswers);
    }

    public void showContrastQuestion(int questionIndex){
        int totalNumberQuestion = undertoneQuestions.length + contrastQuestions.length;
        number_question.setText((questionIndex+undertoneQuestions.length+1) + "/" + totalNumberQuestion);
        text_question.setText(contrastQuestions[questionIndex]);
        showAnswer(contrastAnswers[questionIndex].length, questionIndex, contrastAnswers);
    }

    public void showBodyTypeQuestion(int questionIndex){
        int totalNumberQuestion = typeShapeQuestions.length;
        number_question.setText((typeShapeQuestions.length+1) + "/" + totalNumberQuestion);
        text_question.setText(typeShapeQuestions[questionIndex]);
        showAnswer(typeShapeAnswers[questionIndex].length, questionIndex, typeShapeAnswers);
    }
